...
function SearchBar({ placeHolder, displayFilterBtnContainer = "flex", displaySearchBtn = "block" }) {
    ...
    return(
        <form className={styles.searchBar} method="get">
            ...
            <span className={styles.containerFilter} style={{display: displayFilterBtnContainer}}>
            ...
            <button type="submit" className={styles.searchButton} style={{display: displaySearchBtn}}>Search</button>            
        </form>
    )
}
